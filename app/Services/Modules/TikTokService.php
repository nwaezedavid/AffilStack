...
class TikTokService
{
    ...
    protected function run(Generation $generation, string $system, string $userPrompt): void
    {
        ...
        try {
            ...
            Log::error('Unexpected error generating a TikTok video package', ['generation_id' => $generation->id, 'error' => $e->getMessage()]);
        ...
        try {
            ...
            Log::error('Credit spend failed after a successful TikTok generation — content was generated but not charged', [
