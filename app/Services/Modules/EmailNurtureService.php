...
class EmailNurtureService
{
    ...
    protected function run(Generation $generation, string $system, string $userPrompt): void
    {
        ...
        try {
            ...
            Log::error('Unexpected error generating an email nurture sequence', ['generation_id' => $generation->id, 'error' => $e->getMessage()]);
        ...
        try {
            ...
            Log::error('Credit spend failed after a successful email nurture generation — content was generated but not charged', [
